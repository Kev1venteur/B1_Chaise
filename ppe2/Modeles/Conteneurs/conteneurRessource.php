...
Class conteneurRessource
	...
	{
		$liste ='<div class="table-responsive table-css-perso"><table id="tabRessource" class="table table-striped table-bordered" cellspacing="0">
			<thead>
				<tr>
					<td>Info</td>
				</tr>
			</thead>
		<tbody class="rowrowrow">';
	foreach ($this->lesRessources as $uneRessource)
	{
		$liste = $liste.'<tr><td>'.$uneRessource->getNomRessource().'</td></tr>';
	}
